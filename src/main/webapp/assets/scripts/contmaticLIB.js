; (function() {
    ...
    window.contmatic = {
        ...
        postJSON: function (url, options) {
            var xhr = contmatic.createRequest('POST', url, {async: true});
        ...
        loadJSON: function(url) {
            return contmatic.syncRequestJSON('GET', url);
        },

        deleteJSON: function(url) {
            return contmatic.syncRequestJSON('DELETE', url);
        },
        ...
        requestAJAX: function(settings ) {
            var jqXHR = contmatic.createRequest(settings.method, settings.url, {async: settings.async});
